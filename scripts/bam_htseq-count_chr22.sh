...
## requires bam data sorted by 'queryname' as in our markdup set
...
echo "Usage: ${0##*/} <bam file>
	eg: tophat2.0.13-SRR1039509_results/markdup_bams/chr22_SRR1039509_all_mdup.bam"
exit
fi

...
# first line processes all chr22-fastq while second takes only one dataset
#export RAWDATA=$BASE/SRP033351-chr22_fastq
export RAWDATA=$BASE/SRR1039509_fastq

export READQC=$BASE/SRR1039509_read_qc-Results
